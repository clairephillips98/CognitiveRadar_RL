#!/bin/bash
name='apr_12_penalty_airport_cond_a8_t30_r2_e0.5'
radars=2
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_2.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_3.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_6.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_7.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_8.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr12_9.txt
module load anaconda3
echo 1
source activate pytorch_env

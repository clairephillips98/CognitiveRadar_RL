#!/bin/bash
name='apr_15_penalty_airport_cond_a8_t30_r2_e0.5'
radars=2
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_1.txt
module load anaconda3
echo 1
source activate pytorch_env
# 2 radars, nm, pnm
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_2.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_3.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_4.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_5.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_6.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_7.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_8.txt
module load anaconda3
echo 1
source activate pytorch_env
...
#SBATCH --time=9:00:0
#SBATCH --export=ALL
#SBATCH --output=cphil_test_apr15_9.txt
module load anaconda3
echo 1
source activate pytorch_env
